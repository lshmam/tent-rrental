            ...
            <section className="relative h-[300px] flex items-center justify-center mt-16">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl px-8 py-6 max-w-3xl mx-auto">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">Fans</h1>
                        <p className="text-white text-lg md:text-xl max-w-3xl mx-auto">
                            Keep your guests comfortable with our powerful industrial cooling fans. Perfect for summer events and tented celebrations.
                        </p>
                    </div>
                </div>
            </section >
