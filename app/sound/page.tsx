    ...
    const products = [
        {
            ...
            description:
                "Crystal-clear audio for speeches, music, and entertainment. Our professional-grade sound systems ensure every guest can hear perfectly, whether you're hosting an intimate gathering or a large celebration.",
            image: "/sound-system.jpeg",
            features: ["Crystal-clear audio", "Wireless microphones", "Professional setup", "All event sizes"],
        },
    ]
            ...
            <section className="relative h-[300px] flex items-center justify-center mt-16">
                ...
                <div className="relative z-10 container mx-auto px-4 text-center">
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl px-8 py-6 max-w-3xl mx-auto">
                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">Sound Systems</h1>
                        <p className="text-white text-lg md:text-xl max-w-3xl mx-auto">
                            Professional audio equipment for crystal-clear sound at any event. From intimate gatherings to large celebrations.
                        </p>
                    </div>
                </div>
            </section >
                ...
                <div className="max-w-2xl mx-auto">
                    <Card className="overflow-hidden hover:shadow-xl transition-shadow">
                        ...
                        <div className="relative aspect-[4/3] bg-white">
                            ...
                            {/* Carousel Navigation - only show if more than 1 product */}
                            {products.length > 1 && (
                                <>
                                    <button
                                        onClick={prevSlide}
                        ...
                        <CardContent className="p-6">
                            ...
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                ...
                                <p className="text-sm text-blue-700">
                                    Sound system prices depend on your venue size and event requirements. Contact us for a personalized quote.
                                </p>
                            </div>
